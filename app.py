...
class BoroughRecommender(object):
    ...
    def __init__(
        ...
        self.df_rent = pd.read_pickle(rent_pickle)
        self.df_venues = pd.read_pickle(venues_pickle)
        self.df_groups = pd.read_pickle(groups_pickle)
        self.df_preferences = None
        self.ldn_geojson = ldn_geojson
